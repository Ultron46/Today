...
namespace DevOps.UI.Controllers
{
    ...
    public class PackageController : Controller
    {
        ...
        public async Task<ActionResult> GetAllPackage(int id)
        {
            string address;
            var client = new HttpClient();
            ...
            {
                var Projects = Res.Content.ReadAsStringAsync().Result;
                packageReleases = JsonConvert.DeserializeObject<List<PackageRelease>>(Projects);
            }
            ViewBag.ReleaseProjectId = id;
            ViewBag.packages = packageReleases;
            return PartialView("GetAllPackage");
        }
    }
}